...
from .icons import (
    icon_document_type_smart_links, icon_smart_link_condition_create,
    icon_smart_link_condition_delete, icon_smart_link_condition_edit,
    icon_smart_link_condition_list, icon_smart_link_create,
    icon_smart_link_delete, icon_smart_link_document_types,
    icon_smart_link_edit, icon_smart_link_instances_for_document,
...
link_smart_link_document_types = Link(
    args='object.pk', icon=icon_smart_link_document_types,
...
link_smart_link_instances_for_document = Link(
    ...
    icon=icon_smart_link_instances_for_document,
